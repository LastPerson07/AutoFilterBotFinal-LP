class script(object):
    START_TXT = """<b><u>𝗡𝗘𝗧𝗙𝗟𝗜𝗫𝗜𝗔𝗡 𝗫</u></b>
...
├⍟ Mʏ Nᴀᴍᴇ : <a href=http://t.me/THEUPDATEDGUYS_Bot>THE UPDATED GUYS 😎</a>
├⍟ Dᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/DmOwner>Ⓜ️ark</a> 
├⍟ Lɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a>
├⍟ Lᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 𝟹</a> 
├⍟ Dᴀᴛᴀʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
├⍟ Bᴏᴛ Sᴇʀᴠᴇʀ : ᴍᴏᴏɴ ʙᴀsᴇ
├⍟ Bᴜɪʟᴅ Sᴛᴀᴛᴜs : ᴠ1.4 [ ꜱᴛᴀʙʟᴇ ]
├⍟ Sᴘᴇᴄɪᴀʟ Tʜᴀɴᴋꜱ : Aʙʜᴀʏ Rᴀᴊʙʜᴀʀ, Rᴀᴊ Bᴀᴅɢᴇ
╰───────────────⍟</b>"""
    RESTART_TXT = """
<b>{} Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ !
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/Netflixian_Movie">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/Netflixian_Movie">[ Netflixian X ]</a></b>"""
...
•─────•─────────•─────•
🏷️ <a href='Netflixian X'>⚡ ᴅᴏɴ’ᴛ ᴘᴀʏ ᴀ ᴘᴇɴɴʏ, ᴅᴜᴅᴇ! ᴇᴠᴇʀʏᴛʜɪɴɢ ɪꜱ ꜰʀᴇᴇ ᴊᴜꜱᴛ ꜰᴏʀ ᴛʜᴇ ᴍᴇᴍᴇs 😎🔥</a>

‼️ ᴘᴀʏᴇᴅ? ᴛɪᴍᴇ ᴛᴏ ᴘʀᴏᴏғ ɪᴛ! ꜱʜᴏᴡ ᴜꜱ ᴀ ᴄᴏᴏʟ ᴅᴇʀᴘ ᴅᴇᴅɪᴄᴀᴛᴇᴅ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ.
‼️ ᴅʀᴏᴘ ɪᴛ ᴀɴᴅ ᴄʜɪʟʟ — ᴡᴇ’ʟʟ ᴍᴀʏʙᴇ ᴘᴜᴛ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ᴄʟᴜʙ 😎✨"""

    PREMIUM_STAR_TEXT = """<b><blockquote>ᴘᴀʏᴍᴇɴᴛ ᴍᴇᴛʜᴏᴅ: ᴛᴇʟᴇɢʀᴀᴍ ꜱᴛᴀʀꜱ ⭐</blockquote>

✨ ɢᴇᴛ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴠɪʙᴇꜱ ᴡɪᴛʜ ᴛᴇʟᴇɢʀᴀᴍ ꜱᴛᴀʀꜱ!

⚠️ ɪꜰ ᴛʜɪɴɢꜱ ɢᴏ ᴡʀᴏɴɢ, ᴄᴀᴘᴛᴜʀᴇ ᴀ ꜱᴄʀᴇᴇɴ & ʜɪᴛ ᴜꜱ ᴜᴘ — @NetflixNowClub

🍕 ᴄʜᴏᴏsᴇ ʏᴏᴜʀ ᴅʀᴇᴀᴍ ᴀᴍᴏᴜɴᴛ ᴀɴᴅ ʙᴜʏ ᴀ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ — ʙᴇᴄᴀᴜꜱᴇ ʏᴏᴜ ᴅᴇꜱᴇʀᴠᴇ ᴛʜᴀᴛ ᴘɪᴢᴢᴀ 🍕✨</b>
"""
...
💢 ᴘᴀʏᴇᴅ? ᴛɪᴍᴇ ᴛᴏ ᴘʀᴏᴏғ ɪᴛ! ꜱʜᴏᴡ ᴜꜱ ᴀ ᴄᴜᴛᴇ ᴏʀ ᴄʀᴀᴢʏ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ.

‼️ ᴅʀᴏᴘ ɪᴛ ᴀɴᴅ ᴄʜɪʟʟ — ᴡᴇ’ʟʟ ᴍᴀʏʙᴇ ᴘᴜᴛ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ᴄʟᴜʙ 😎✨</b>"""
...
○ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇꜱ, ɴᴏ ᴄʀᴀᴢʏ ʟɪɴᴋꜱ 🔗
○ ᴀᴅ-ꜰʀᴇᴇ ᴠɪʙᴇꜱ 😎
○ ʜɪɢʜ-ꜱᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ⚡
○ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ ꜱᴛʀᴇᴀᴍɪɴɢ 🎬
○ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇꜱ & ꜱᴇʀɪᴇꜱ 🍿
○ ꜰᴜʟʟ ᴀᴅᴍɪɴ ᴘᴏᴡᴇʀ ⚡
○ ʀᴇǫᴜᴇꜱᴛꜱ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 1ʜ ⏰ (ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ)

• ɢᴇᴛ ᴘʀᴇᴍɪᴜᴍ ʙʏ ʀᴇꜰᴇʀʀɪɴɢ ꜰʀɪᴇɴᴅꜱ ᴏʀ ᴊᴜsᴛ ʙᴜʏ ɪᴛ 💎
•─────•─────────•─────•
◉ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ : /myplan

‼️ ᴅʀᴏᴘ ᴛʜᴀᴛ ꜱᴄʀᴇᴇɴ ᴀɴᴅ ᴛᴀᴋᴇ ᴀ ʙʀᴇᴀᴋ — ᴡᴇ’ʟʟ ᴛʀʏ ᴛᴏ ᴘᴏᴡᴇʀ ʏᴏᴜ ɪɴᴛᴏ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ᴄʟᴜʙ 😎✨"""  
...
🧾 ᴘᴀʏ ʏᴏᴜʀ ᴄʜɪʟʟ ᴘʟᴀɴ ᴀɴᴅ ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ ʟɪꜱᴛ ʙᴇɴᴇꜰɪᴛꜱ! 🎉

‼️ ᴅʀᴏᴘ ᴀ ꜱᴄʀᴇᴇɴ ᴀꜰᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ 📸
‼️ ᴛʜᴇɴ ᴘᴀᴛ ʏᴏᴜʀ ᴘᴀᴛɪᴇɴᴄᴇ ᴏɴ ᴛʜᴇ ʜᴇᴀᴅ 🤏 — ᴡᴇ’ʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟʟʏ ᴀᴅᴅ ʏᴏᴜ ᴛᴏ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ᴄʟᴜʙ 😎✨
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/DmOwner'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
💸 ᴅʀᴏᴘ ᴛʜᴇ ᴄᴀ$ʜ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ᴘʟᴀɴ & ᴅɪᴠᴇ ɪɴᴛᴏ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀꜱʜɪᴘ ᴠɪʙᴇꜱ! 🎉😎
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
 ...
 📸 ᴅᴏɴ’ᴛ ғᴏʀɢᴇᴛ ᴛᴏ sʜᴏᴡ ᴜꜱ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴘʀᴏᴏғ — ᴛʜᴀᴛ ᴍᴇᴍᴇ ᴄʀᴀᴘ ᴡᴏɴ’ᴛ ᴘʀᴏᴏғ ɪᴛsᴇʟꜰ! 😎✨

📸 ǫʀ ᴄᴏᴅᴇ - <a href='{}'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>

📸 ᴘᴀʏᴇᴅ? ᴛɪᴍᴇ ᴛᴏ ᴘʀᴏᴏғ ɪᴛ — sʜᴏᴡ ᴜꜱ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴄᴀᴘᴛᴜʀᴇ! 😎✨</b>"""

    SOURCE_TXT ="""<b>🧙‍♂️ ᴛʜᴇ ᴍᴀɢɪᴄ ᴄᴏᴅᴇ ᴛʜᴀᴛ ᴅᴏᴇs ᴇᴠᴇʀʏᴛʜɪɴɢ 🤯💥 </b>

This is a paid project. If you are interested in using it, please contact us for access. Unauthorized use or distribution of the source code is strictly prohibited.\n
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/DmOwner>Ⓜ️ark</a>\n """
