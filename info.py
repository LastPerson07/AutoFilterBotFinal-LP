...
# ============================
SESSION = environ.get('SESSION', 'THE UPDATED GUYS 😎')   # Session name for the bot
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003046731760')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001557378145')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/NetflixNowClub')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sharmadhanpal950:dhanpalsharma25@cluster0.cv3mo9g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001557378145'))  # Notification of sent to your channel
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Netflixian_Movie")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/NetflixNowClub') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DmOwner') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Netflixian_Movie') # Update channel link for the bot
